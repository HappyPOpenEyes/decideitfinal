...
GetPersonalData getPersonalDataFromJson(String str) =>
    GetPersonalData.fromJson(json.decode(str));

String getPersonalDataToJson(GetPersonalData data) =>
...
class GetPersonalData {
  ...
  factory GetPersonalData.fromJson(Map<String, dynamic> json) =>
      GetPersonalData(
        id: json["id"],
