...
//
//     final funnelChartData = funnelChartDataFromJson(jsonString);

import 'dart:convert';

FunnelChartData funnelChartDataFromJson(String str) => FunnelChartData.fromJson(json.decode(str));

String funnelChartDataToJson(FunnelChartData data) => json.encode(data.toJson());
...
class FunnelChartData {
    ...
    List<QuestionCommentFunnel> questionComments;
    List<UserOptionFunnel> userOptions;

    factory FunnelChartData.fromJson(Map<String, dynamic> json) => FunnelChartData(
        questionComments: List<QuestionCommentFunnel>.from(json["questionComments"].map((x) => QuestionCommentFunnel.fromJson(x))),
        userOptions: List<UserOptionFunnel>.from(json["userOptions"].map((x) => UserOptionFunnel.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "questionComments": List<dynamic>.from(questionComments.map((x) => x.toJson())),
        "userOptions": List<dynamic>.from(userOptions.map((x) => x.toJson())),
    };
}

class QuestionCommentFunnel {
    QuestionCommentFunnel({
        required this.id,
        required this.questionId,
        required this.questionInviteeId,
    ...
    String userOptions;
    List<ChartDataFunnel> chartData;
    String postedTime;
    ...
    factory QuestionCommentFunnel.fromJson(Map<String, dynamic> json) => QuestionCommentFunnel(
        id: json["id"],
        ...
        chartData: List<ChartDataFunnel>.from(json["chart_data"].map((x) => ChartDataFunnel.fromJson(x))),
...
class ChartDataFunnel {
    ...
    factory ChartDataFunnel.fromJson(Map<String, dynamic> json) => ChartDataFunnel(
...
class UserOptionFunnel {
    ...
    factory UserOptionFunnel.fromJson(Map<String, dynamic> json) => UserOptionFunnel(
        id: json["id"],
        questionId: json["question_id"],
        value: json["value"],
        isActive: json["is_active"],
